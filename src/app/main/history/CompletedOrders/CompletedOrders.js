...
class CompletedOrders extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://api.zacarta.com/api/buyer/order/getAllOrders?type=2', { headers: headers }).then(res => {
            this.setState({
                open:false
            })
                                                ...
                                                {this.state.orders.slice(this.state.page * this.state.rowsPerPage, this.state.page * this.state.rowsPerPage + this.state.rowsPerPage).map((order, index) => {
                                                    ...
                                                    return (
                                                        <TableRow hover>
                                                            ...
                                                            {/* <TableCell><span><img src="https://img.icons8.com/material-outlined/24/000000/us-dollar.png"/></span>{order.order_total}</TableCell> */}
